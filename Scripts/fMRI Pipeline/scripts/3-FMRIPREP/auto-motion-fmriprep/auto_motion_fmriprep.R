...
if (!require("snakecase", quietly = TRUE)) {
  install.packages("snakecase", lib = Sys.getenv("R_LIBS_USER"))
  library("snakecase")
}
...
# load classifier
mlModel = readRDS('/data00/tools/auto-motion-fmriprep/motion_classifier.rds')
